...
> **🔗 https://doufutangvgood.github.io/canteen-seat-sim/**
>
> 由 GitHub Pages 托管，点开即用。也可在仓库里直接点击 [`index.html`](index.html)。

### 本地运行

下载后直接用浏览器打开 **`index.html`**（单文件、零依赖、无需联网）——
文件名带中文的 `食堂仿真沙盘.html` 是同一入口的跳转页，两个都能打开。

沙盘把同一套模型移植到了 JavaScript，左侧实时调参、右侧立刻出结果：
...
```
.
├── index.html          # ★ 交互式可视化界面（单文件、零依赖、双击即用；也是 Pages 站点首页）
